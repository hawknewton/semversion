...
Gem::Specification.new do |spec|
  ...
  spec.email = ['hnewton@docgo.com']

  spec.summary = 'Maintain seversion of your repo'
  spec.description = 'Maintain seversion of your repo'
  spec.homepage = 'https://github.com/AmbulnzLLC/semversion'
